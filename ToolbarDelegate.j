...
{
	WordsController wordsController @accessors;
}
...
- (CPToolbarItem)toolbar:(CPToolbar)aToolbar itemForItemIdentifier:(CPString)anItemIdentifier willBeInsertedIntoToolbar:(BOOL)aFlag
{
    ...
    if (anItemIdentifier === AddToolbarItemIdentifier)
    {
    	...
    	[toolbarItem setLabel:"Add Word"];
	[toolbarItem setTarget:wordsController];
    ...
    else if (anItemIdentifier === RemoveToolbarItemIdentifier)
    {
    	...
    	[toolbarItem setLabel:"Delete Word"];
    ...
    else if (anItemIdentifier === EditToolbarItemIdentifier)
    {
    	...
    	[toolbarItem setLabel:"Edit Word"];
